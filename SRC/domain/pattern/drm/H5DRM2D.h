...
class H5DRM2D : public LoadPattern
{
public:
    H5DRM2D();
    H5DRM2D(int tag, std::string HDF5filename_, double cFactor_ = 1.0, 
          double crd_scale_ = 1, 
...
extern Vector H5DRM_calculate_cross_product(const Vector & a, const Vector & b);
extern bool read_int_dataset_into_id(const hid_t & h5drm_dataset, std::string dataset_name, ID & result);
extern bool read_double_dataset_into_vector(const hid_t & h5drm_dataset, std::string dataset_name, Vector & result);
extern bool read_scalar_double_dataset_into_double(const hid_t & h5drm_dataset, std::string dataset_name, double & result);
extern bool read_double_dataset_into_matrix(const hid_t & h5drm_dataset, std::string dataset_name, Matrix & result);
extern bool read_int_dataset_into_array(const hid_t & h5drm_dataset, std::string dataset_name, int *& result);
